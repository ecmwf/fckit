...
#
#        Unless NO_TARGET_DEPENDS is specified, an ordering dependency is
#        established so that all fypp preprocessing completes before any source
#        in the target is compiled. This can prevent build failures due to the
#        Ninja generator's dynamic Fortran module dependency scanning, which
#        will fail to find modules that are generated by fypp.
...
### END BUG WORKAROUND
      ...
      # Use a custom target to ensure all fypp custom commands finish before any
      # source in the target is compiled.
      # Not applied if the same target is invoked a second time.
      if( NOT _PAR_NO_TARGET_DEPENDS AND preprocessed_sources )
        set( _fypp_order_target ${_PAR_TARGET}_fypp_order )
        if( NOT TARGET ${_fypp_order_target} )
