...
public:
  NotLocalConfiguration(const CodeLocation &location)
      : Exception("Configuration must be of concrete LocalConfiguration type",
                  location) {}
};
...
Configuration *c_fckit_configuration_new() { return new LocalConfiguration(); }
...
const Configuration *
c_fckit_configuration_new_from_buffer(eckit::CountedBuffer *buffer) {
...
void c_fckit_configuration_set_config_list(Configuration *This,
                                           const char *name,
                                           const Configuration *value[],
                                           size_t size) {
  ASSERT(This != nullptr);
...
void c_fckit_configuration_set_float(Configuration *This, const char *name,
                                     float value) {
  ASSERT(This != nullptr);
  if (LocalConfiguration *local = dynamic_cast<LocalConfiguration *>(This))
    local->set(string(name), value);
...
void c_fckit_configuration_set_array_int32(Configuration *This,
...
void c_fckit_configuration_set_array_int64(Configuration *This,
...
void c_fckit_configuration_set_array_float(Configuration *This,
...
void c_fckit_configuration_set_array_double(Configuration *This,
...
int32 c_fckit_configuration_get_config(const Configuration *This,
                                       const char *name,
...
int32 c_fckit_configuration_get_config_list(const Configuration *This,
                                            const char *name,
                                            LocalConfiguration **&value,
                                            size_t &size) {
  value = nullptr;
...
int32 c_fckit_configuration_get_bool(const Configuration *This,
                                     const char *name, int32 &value) {
  bool _value;
...
int32 c_fckit_configuration_get_int32(const Configuration *This,
                                      const char *name, int32 &value) {
  if (!This->get(string(name), value))
    return false;
  return true;
...
int32 c_fckit_configuration_get_int64(const Configuration *This,
                                      const char *name, int64 &value) {
  // TODO: long should be converted to int64 once ECKIT-349 is fixed
  long v;
...
int32 c_fckit_configuration_get_float(const Configuration *This,
                                      const char *name, float &value) {
  if (!This->get(string(name), value))
    return false;
  return true;
...
int32 c_fckit_configuration_get_double(const Configuration *This,
                                       const char *name, double &value) {
  if (!This->get(string(name), value))
    return false;
  return true;
...
int32 c_fckit_configuration_get_string(const Configuration *This,
...
int32 c_fckit_configuration_get_array_int32(const Configuration *This,
                                            const char *name, int32 *&value,
                                            size_t &size) {
  vector<int32> v;
  if (!This->get(string(name), v))
...
int32 c_fckit_configuration_get_array_int64(const Configuration *This,
                                            const char *name, int64 *&value,
                                            size_t &size) {
  // TODO: long should be converted to int64 once ECKIT-349 is fixed
  vector<long> v;
...
int32 c_fckit_configuration_get_array_float(const Configuration *This,
                                            const char *name, float *&value,
                                            size_t &size) {
  vector<float> v;
  if (!This->get(string(name), v))
...
int32 c_fckit_configuration_get_array_double(const Configuration *This,
                                             const char *name, double *&value,
                                             size_t &size) {
  vector<double> v;
  if (!This->get(string(name), v))
...
void c_fckit_configuration_json(const Configuration *This, char *&json,
                                size_t &size) {
  stringstream s;
  JSON parser(s);
